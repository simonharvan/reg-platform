...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            {!!
            Former::radios('prefix')
              ->radios(array(
                'Mr' => array('name' => 'prefix', 'value' => 'Mr'),
                'Mrs' => array('name' => 'prefix', 'value' => 'Mrs'),
                'Ms' => array('name' => 'prefix', 'value' => 'Ms'),
              ))->inline()->required()

            !!}

            {!! Former::text('first_name')->required()->help('(as written on Passport / ID)') !!}
            {!! Former::text('last_name')->required()->help('(as written on Passport / ID)') !!}
            {!! Former::text('organization')->required() !!}
            {!! Former::text('position')->required() !!}
            {!! Former::text('address')->required()->help('official residence or work address') !!}
            {!! Former::text('city')->required() !!}
            {{--{!! Former::text('postal_code')->required() !!}--}}
            {!! Former::text('country')->useDatalist($country_list)->required() !!}
            {!! Former::text('nationality')->required() !!}
            {!! Former::text('email')->required() !!}
            {!! Former::text('assistant_email') !!}
            {!! Former::text('phone') !!}
